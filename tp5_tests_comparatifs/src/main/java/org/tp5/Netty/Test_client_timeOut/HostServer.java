...
import org.tp5.Netty.Test_client_timeOut.Initializers.ServerChannelInitializer;
    ...
    public void start() throws Exception {
        ...
        try {
            ...
            bootStrap.group(bossGroup, workerGroup)
                    ...
                    .childHandler(new ServerChannelInitializer(MESSAGE_DELAY_TIME)).option(ChannelOption.SO_BACKLOG, 128)
