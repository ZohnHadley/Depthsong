...
import co.px.depthsong.engin.engineCore.util.SpriteSheet;
...
public class GameSprites {
    ...
    private GameSprites() {
        ...
        spriteMap.put("skier_speeding", spriteSheet.getSprite(1, 0));
        spriteMap.put("skier_braking", spriteSheet.getSprite(2, 0));
        spriteMap.put("skier_turning", spriteSheet.getSprite(3, 0));
        spriteMap.put("pine_tree", spriteSheet.getSprite(4, 0));
