...
public class GameScreenLocalGUIMenu extends GUIScreen {
    ...
    public GameScreenLocalGUIMenu(String _title) {
        super(_title, new Stage());
        screenManager = ScreenManager.getInstance();
    }

    private void prepareComponents(){
        label_screenTitle = new Label("LocalGameMenu", this.getSkin());
        label_screenTitle.setFontScale(2);

        button_host_game = new TextButton("Host Game", this.getSkin());
